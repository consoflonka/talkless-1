...
const Features = () => {
  const features = [
    {
      icon: <Mic className="h-12 w-12 text-purple-400" />,
    ...
    {
      icon: <List className="h-12 w-12 text-blue-400" />,
    ...
    {
      icon: <Phone className="h-12 w-12 text-teal-400" />,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group bg-gray-900/50 backdrop-blur-sm p-6 rounded-xl border border-gray-700/50 hover:border-purple-500/30 transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-purple-500/10 animate-fadeInUp"
        ...
        <div className="text-center mt-16 animate-fadeInUp animation-delay-1000">
          <button className="bg-gradient-to-r from-purple-600 to-blue-600 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:from-purple-700 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-purple-500/25">
